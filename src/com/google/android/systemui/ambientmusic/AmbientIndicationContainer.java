...
public class AmbientIndicationContainer extends AutoReinflateContainer
        ...
        addInflateListener(
                new AutoReinflateContainer.InflateListener() {
                    ...
                    public final void onInflated(View view) {
                        ...
                        mReverseChargingAnimation =
                                mContext.getDrawable(R.anim.reverse_charging_animation);
    ...
    private void updatePill() {
        ...
        CharSequence charSequence3 =
                TextUtils.isEmpty(mIconDescription) ? charSequence : mIconDescription;
        ...
        if (drawable2 != null) {
            ...
            MathUtils.fitRect(
                    mIconBounds,
                    drawable2 == mAmbientMusicNoteIcon
                            ? mAmbientMusicNoteIconIconSize
                            : mAmbientIndicationIconSize);
            drawable =
                    new DrawableWrapper(drawable2) {
                        @Override
    ...
    private void updateBottomSpacing() {
        ...
        mStatusBar
                .getPanelController()
                .setAmbientIndicationTop(getTop(), mTextView.getVisibility() == 0);
    }
